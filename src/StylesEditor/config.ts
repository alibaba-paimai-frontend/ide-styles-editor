...
import { DEFAULT_PROPS, IStylesEditorProps } from '.';
...
export const configStylesEditor: IModuleConfig<IStylesEditorProps, ISubProps> = {
  component: {
...
// 当然也可以自己枚举
export const SELF_CONTROLLED_KEYS = Object.keys(configStylesEditor.model.props); // ['visible', 'text']
...
// 初始化 controlledKeys
configStylesEditor.model.controlledKeys = CONTROLLED_KEYS;
