...
import { StylesEditorFactory } from '../../../src';
import { modelPropsGen } from '../../helper';

const {
  ComponentWithStore: StylesEditorWithStore1,
  client: client1
} = StylesEditorFactory();

// const {
//   StylesEditorWithStore: StylesEditorWithStore2,
//   client: client2
// } = StylesEditorFactory();
  ...
  .addWithJSX('/model 获取属性信息', () => {
    return (
      <Row style={styles.demoWrap}>
        ...
        <Col span={24}>
          <StylesEditorWithStore1 onClick={onClick} />
        </Col>
      </Row>
    );
  });